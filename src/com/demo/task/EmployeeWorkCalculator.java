...
/**
 * 
 * Class with methods for calculating longest team period.
 * 
...
public class EmployeeWorkCalculator {
	...
	//Method for calculating team perion from given file name. 
	public void calculateFromFile(String fileName) {
		ArrayList<Task> tasks = getTasksArray(fileName);
		calculateLongestTeamwork(tasks);
	}
	
	//Creating object of Task from every single line and adding them to an array.
	...
	//Calculating and printing longest team work of two employees from given array.
